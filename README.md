...
| Room.php           | `createRoom()`                  | 创建音视频房间                    |
| Room.php           | `createChannel()`               | 创建频道                       |
| RoomStreamTask.php | `createStreamTaskV3()`          | 创建旁路推流任务                   |
| RoomStreamTask.php | `createStreamTaskV3ByCid()`     | 创建旁路推流任务                   |
| RoomStreamTask.php | `getStreamTaskV3()`             | 查询指定旁路推流任务                 |
| RoomStreamTask.php | `updateStreamTaskV3()`          | 更新旁路推流任务                   |
| RoomStreamTask.php | `deleteStreamTaskV3()`          | 停止旁路推流任务                   |
| RoomStreamTask.php | `deleteStreamTask()`            | 停止旁路推流任务                   |
